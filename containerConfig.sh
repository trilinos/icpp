...
if [[ $CONFIG == "dependencies" ]] ; then
    ##################################################
    # container name
    CONTAINER_NAME=trilinos-dependencies

    ##################################################
    # image
    CONTAINER_HOME=/root

    IMAGE=ghcr.io/trilinos/dependencies-cuda:latest
    DOCKERFILE=${SCRIPT_PATH}/Dockerfile.dependencies-cuda
    ...
    ##################################################
    # container name
    CONTAINER_NAME=trilinos

    ##################################################
    # image
    CONTAINER_HOME=/root

    IMAGE=ghcr.io/trilinos/trilinos-cuda:latest
    DOCKERFILE=${SCRIPT_PATH}/Dockerfile.trilinos-cuda
